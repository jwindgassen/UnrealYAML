...
public:
	...
	UFUNCTION(BlueprintCallable, Category="YAML|Convert", meta=(ExpandBoolAsExecs="ReturnValue"))
	static bool AsStringLongMap(const FYamlNode& Node, const TMap<FString, int64>& Default, TMap<FString, int64>& Value);
	...
	UFUNCTION(BlueprintCallable, Category="YAML|Convert", meta=(ExpandBoolAsExecs="ReturnValue"))
	static bool AsStringByteMap(const FYamlNode& Node, const TMap<FString, uint8>& Default, TMap<FString, uint8>& Value);
	...
	UFUNCTION(BlueprintCallable, Category="YAML|Convert", meta=(ExpandBoolAsExecs="ReturnValue"))
	static bool AsStringFloatMap(const FYamlNode& Node, const TMap<FString, float>& Default, TMap<FString, float>& Value);
	...
	UFUNCTION(BlueprintCallable, Category="YAML|Convert", meta=(ExpandBoolAsExecs="ReturnValue"))
	static bool AsStringStringMap(const FYamlNode& Node, const TMap<FString, FString>& Default, TMap<FString, FString>& Value);
	...
	UFUNCTION(BlueprintCallable, Category="YAML|Convert", meta=(ExpandBoolAsExecs="ReturnValue"))
	static bool AsStringTextMap(const FYamlNode& Node, const TMap<FString, FText>& Default, TMap<FString, FText>& Value);
	...
	UFUNCTION(BlueprintCallable, Category="YAML|Convert", meta=(ExpandBoolAsExecs="ReturnValue"))
	static bool AsStringVectorMap(const FYamlNode& Node, const TMap<FString, FVector>& Default, TMap<FString, FVector>& Value);
	...
	UFUNCTION(BlueprintCallable, Category="YAML|Convert", meta=(ExpandBoolAsExecs="ReturnValue"))
	static bool AsStringQuatMap(const FYamlNode& Node, const TMap<FString, FQuat>& Default, TMap<FString, FQuat>& Value);
	...
	UFUNCTION(BlueprintCallable, Category="YAML|Convert", meta=(ExpandBoolAsExecs="ReturnValue"))
	static bool AsIntTransformMap(const FYamlNode& Node, const TMap<int32, FTransform>& Default, TMap<int32, FTransform>& Value);
	UFUNCTION(BlueprintCallable, Category="YAML|Convert", meta=(ExpandBoolAsExecs="ReturnValue"))
	static bool AsStringTransformMap(const FYamlNode& Node, const TMap<FString, FTransform>& Default, TMap<FString, FTransform>& Value);
};
